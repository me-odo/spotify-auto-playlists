# Spotify Auto-Playlists — Modern Pipeline Architecture
...
Spotify API
 ...
 Tracks Loader (sources)
     |
     v
 Feature Providers (AcousticBrainz, MB, LLM, …)
     |
     v
 Classifiers (mood, genre, energy…)
     |
     v
...
### Pipeline Layer
Pure business logic. Context‑agnostic.
...
### Track sources
[{ "type": "liked_tracks" }, { "type": "playlist", "playlist_id": "…" }]
...
- POST /pipeline/{step}/run-async → job_id
